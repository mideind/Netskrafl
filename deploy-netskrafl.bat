...
set GOOGLE_APPLICATION_CREDENTIALS=credentials\netskrafl\service-account.json
:CHECKS
...
cmd.exe /c "npx grunt make"
gcloud app deploy --no-cache --version=%2 --no-promote --project=netskrafl app-netskrafl.yaml
